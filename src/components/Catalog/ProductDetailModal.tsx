          ...
          <div className="product-modal__info">
            ...
            <div className="product-modal__specs">
              {producto.procedencia && (
                <div className="spec-item">
                  ...
                  <span><strong>Origen:</strong> {producto.procedencia}</span>
                </div>
              )}
              {producto.grados_alcohol !== undefined && (
                <div className="spec-item">
                  <i className="fas fa-percent"></i>
                  <span><strong>Alcohol:</strong> {producto.grados_alcohol}%</span>
                </div>
              )}
              {producto.volumen_ml && (
                <div className="spec-item">
                  <i className="fas fa-flask"></i>
                  <span><strong>Volumen:</strong> {producto.volumen_ml}ml</span>
                </div>
              )}
            </div>
            ...
            {(producto.sabores || producto.notas_cata) && (
              <div className="product-modal__notas">
                <h4><i className="fas fa-wine-glass"></i> Perfil de Sabor</h4>
